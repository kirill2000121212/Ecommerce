...
import Youtube from '@/assets/icons/socialIcon/Youtube.svg'
import Mastercard from '@/assets/icons/coloredIcon/Mastercard.svg'
import Amex from '@/assets/icons/coloredIcon/Amex.svg'
import Visa from '@/assets/icons/coloredIcon/Visa.svg'
